...
# Load the data
train = pd.read_csv(r"/Users/soarchorale/Desktop/pcl/kaggle/competitions/getting-started/digit-recognizer/data/train.csv")
test = pd.read_csv(r"/Users/soarchorale/Desktop/pcl/kaggle/competitions/getting-started/digit-recognizer/data/test.csv")
...
submission.to_csv("/Users/soarchorale/Desktop/pcl/kaggle/competitions/getting-started/digit-recognizer/data/Result_keras_CNN.csv",index=False)
